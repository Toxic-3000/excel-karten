/* Spieleliste Webansicht – Clean Rebuild – Build 7.0k-V
   - Kompaktansicht only
   - Badges mit möglichst fixer Länge
   - Alle Zustände für Quelle/Verfügbarkeit werden angezeigt
   - Store Link: Linktext + echte URL aus Excel (Hyperlink) */

console.log("Build 7.0k-V loaded");

(() => {
  "use strict";
  const BUILD = (document.querySelector('meta[name="app-build"]')?.getAttribute("content") || "7.0k-V").trim();
...
// Kartenkopf: Trophy-Badges (Build 7.0k-V)
// Standard: 1 Badge
