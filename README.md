...
- v6.5: ID-Badge dunkler blau; Humorstatistik separat ausklappbar; Summary-Texte anzeigen/verbergen zustandsabhängig (Beschreibung/Store/Trophäen/Humor).
- v6.5: Startet nach dem XLSX-Laden immer in Kompaktansicht; Badge-Zeile fest unter dem Titel (kein Verrutschen durch lange Titel).
