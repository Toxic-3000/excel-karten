...
console.log("Build 7.1g loaded");
/* Spieleliste Webansicht – Clean Rebuild – Build 7.1g
   - Kompaktansicht only
...
(() => {
  "use strict";
  const BUILD = (document.querySelector('meta[name="app-build"]')?.getAttribute("content") || "7.1g").trim();
