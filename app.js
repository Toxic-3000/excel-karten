...
console.log("Build 7.1d loaded");
/* Spieleliste Webansicht – Clean Rebuild – Build 7.1d
   - Kompaktansicht only
...
(() => {
  "use strict";
  const BUILD = (document.querySelector('meta[name="app-build"]')?.getAttribute("content") || "7.1d").trim();
