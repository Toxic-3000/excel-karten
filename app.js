...
console.log("Build 7.0v-B1 loaded");
/* Spieleliste Webansicht – Clean Rebuild – Build 7.0v-B1
   - Kompaktansicht only
...
(() => {
  "use strict";
  const BUILD = (document.querySelector('meta[name="app-build"]')?.getAttribute("content") || "7.0v-B1").trim();
