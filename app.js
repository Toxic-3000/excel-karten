...
console.log("Build 7.1j34 loaded");
/* Spieleliste Webansicht – Clean Rebuild – Build 7.1j34
...
(() => {
  "use strict";
  const BUILD = (document.querySelector('meta[name="app-build"]')?.getAttribute("content") || "7.1j34").trim();
