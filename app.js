...
console.log("Build 7.1j36 loaded");
/* Spieleliste Webansicht – Clean Rebuild – Build 7.1j36
...
(() => {
  "use strict";
  const BUILD = (document.querySelector('meta[name="app-build"]')?.getAttribute("content") || "7.1j36").trim();
