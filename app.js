...
console.log("Build 7.1i10 loaded");
/* Spieleliste Webansicht – Clean Rebuild – Build 7.1i
   - Kompaktansicht only
...
(() => {
  "use strict";
  const BUILD = (document.querySelector('meta[name="app-build"]')?.getAttribute("content") || "7.1i10").trim();
