...
console.log("Build 7.1j27 loaded");
/* Spieleliste Webansicht – Clean Rebuild – Build 7.1j27
...
(() => {
  "use strict";
  const BUILD = (document.querySelector('meta[name="app-build"]')?.getAttribute("content") || "7.1j27").trim();
